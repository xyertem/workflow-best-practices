		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#demoworkflowdevemployeeinfostarui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoworkflowdevemployeeinfostarui-display": {
								"semanticObject": "demoworkflowdevemployeeinfostarui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.workflow.dev.employeeinfostarui",
									"url": sap.ui.require.toUrl("demo/workflow/dev/employeeinfostarui")
								}
							}
						}
					}
