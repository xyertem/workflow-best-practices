		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demoworkflowdevworkflowfirstusertaskui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoworkflowdevworkflowfirstusertaskui-display": {
								"semanticObject": "demoworkflowdevworkflowfirstusertaskui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.workflow.dev.workflowfirstusertaskui",
									"url": sap.ui.require.toUrl("demo/workflow/dev/workflowfirstusertaskui")
								}
							}
						}
					}
