		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#demoworkflowdevworkflowlistuiworkflowlistui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoworkflowdevworkflowlistuiworkflowlistui-display": {
								"semanticObject": "demoworkflowdevworkflowlistuiworkflowlistui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.workflow.dev.workflowlistui.workflowlistui",
									"url": sap.ui.require.toUrl("demo/workflow/dev/workflowlistui/workflowlistui")
								}
							}
						}
					}
